...
--
-- Host: localhost    Database: hw3_new
-- ------------------------------------------------------
...
INSERT INTO `Album` VALUES (1,'Midnights'),(2,'Lover'),(3,'Red'),(4,'Bobby Tarantino II'),(5,'Everybody'),(6,'Under Pressure'),(7,'Bloom'),(8,'Blue Neighbourhood'),(9,'Answer 3');
...
INSERT INTO `Artist` VALUES (1,'Taylor Swift'),(2,'Logic'),(3,'Troye Sivan'),(4,'Vennu Mallesh'),(5,'Answer 6'),(6,'Answer 7');
...
INSERT INTO `Genre` VALUES (1,'Pop'),(2,'Country'),(3,'Rock'),(4,'Rap'),(5,'Answer 5');
...
INSERT INTO `Listener` VALUES (1,'Morty Smith','American'),(2,'Rick Sanchez','American'),(3,'Motu','Indian'),(4,'Patlu','Indian'),(5,'John Wick','American'),(6,'Chhota Bheem','Indian'),(7,'Chutki','Indian'),(9,'Papa Smurf','Belgian'),(10,'Smurfette','Belgian'),(12,'Bob','Answer 4 Partial'),(13,'Rob','Answer 4 Full'),(14,'Cob','American');
...
INSERT INTO `ListeningTo` VALUES (1,1,100000),(1,10,99999999),(1,11,2908752),(1,12,7812374),(1,13,4893214),(1,14,5032948),(1,15,92387422),(1,22,1),(2,11,287349399),(2,22,1),(3,1,4938242),(3,2,9843251),(3,5,84093284),(3,9,87432983),(4,1,4938242),(4,2,9843251),(4,5,84093284),(4,9,87432983),(5,15,287349399),(5,19,1000),(5,22,1),(6,4,2340982),(6,5,2308422),(6,8,8324024),(6,17,3840224),(6,18,2140893),(7,2,8403293),(7,3,9830243),(7,4,8309234),(7,5,3420432),(7,11,34820424),(7,13,4320943),(7,19,8309424),(9,1,99999999),(9,2,99999999),(9,3,99999999),(9,4,99999999),(9,5,99999999),(9,8,99999999),(9,9,99999999),(9,10,99999999),(9,11,99999999),(9,12,99999999),(9,13,99999999),(9,14,99999999),(9,15,99999999),(9,16,99999999),(9,17,99999999),(9,18,99999999),(9,19,99999999),(10,8,223000),(12,1,1),(14,22,1);
...
-- Dump completed on 2022-11-06 14:55:00
